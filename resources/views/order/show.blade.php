                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="list-unstyled">
                            ...
                            @if ($order->order_method === 'Pickup' && in_array($order->status, ['In Work', 'Assign Delivery', 'Delivery', 'Pay', 'Complete']))
                                <li>
                                    <a href="{{ route('order.proof-of-pickup', $order->id) }}" class="text-decoration-none" target="_blank">
                            ...
                            @if ($order->delivery_option && $order->status === 'Complete')
                                <li>
                                    <a href="{{ route('order.proof-of-delivery', $order->id) }}" class="text-decoration-none" target="_blank">
                            ...
                            <li>
                                <a href="{{ route('billing.invoice', $order->id) }}" class="text-decoration-none" target="_blank"
